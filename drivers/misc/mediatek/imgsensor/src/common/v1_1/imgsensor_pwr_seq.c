...
#endif
#if defined(GC32E2_MIPI_RAW_AVATARL5)
    {
        SENSOR_DRVNAME_GC32E2_MIPI_RAW_AVATARL5,
        {
...
#endif
#if defined(GC32E1_MIPI_RAW_AVATARL5)
    {
        SENSOR_DRVNAME_GC32E1_MIPI_RAW_AVATARL5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC32E2_MIPI_MONO_AVATARL5)
    {
        SENSOR_DRVNAME_GC32E2_MIPI_MONO_AVATARL5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC08A8_MIPI_RAW_AVATARL5)
    {
        SENSOR_DRVNAME_GC08A8_MIPI_RAW_AVATARL5,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  3},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC02M1B_MIPI_MONO_AVATARL5)
    {
        SENSOR_DRVNAME_GC02M1B_MIPI_MONO_AVATARL5,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#if defined(OV50D40_MIPI_RAW_23281)
    {
        SENSOR_DRVNAME_OV50D40_MIPI_RAW_23281,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(IMX615_MIPI_RAW_23281)
    {
        SENSOR_DRVNAME_IMX615_MIPI_RAW_23281,
        {
            {RST, Vol_Low, 1},
            {AVDD, Vol_2900, 0},
            {DVDD, Vol_1100, 0},
...
#endif
#if defined(IMX355_MIPI_RAW_23281)
    {
        SENSOR_DRVNAME_IMX355_MIPI_RAW_23281,
        {
            {RST, Vol_Low, 1},
            {AVDD, Vol_2800, 0},
            {DVDD, Vol_1200, 0},
...
#endif
#if defined(OV02B10_MIPI_RAW_23281)
    {
        SENSOR_DRVNAME_OV02B10_MIPI_RAW_23281,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 8},
...
#endif
#if defined(OV02B1B_MIPI_MONO_23281)
    {
        SENSOR_DRVNAME_OV02B1B_MIPI_MONO_23281,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 8},
...
#endif
#if defined(S5KHM6S_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_S5KHM6S_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(S5KJN1_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_S5KJN1_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(OV08D10_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_OV08D10_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(SC1300CS_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_SC1300CS_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {DVDD, Vol_1200, 1},
...
#endif
#if defined(SC820CS_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_SC820CS_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(GC08A8_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_GC08A8_MIPI_RAW_BARLEY,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
...
#endif
#if defined(SC202CS_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},//5
            {AVDD, Vol_2800, 1},//3
...
#endif
#if defined(GC02M1_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_GC02M1_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(GC08A8_MIPI_RAW_ALPHAL5)
    {
...
#endif
#if defined(GC16B3C_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_GC16B3C_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {DVDD, Vol_1200, 1},
...
#endif
#if defined(S5KJNS_MIPI_RAW_BARLEY)
    {
        SENSOR_DRVNAME_S5KJNS_MIPI_RAW_BARLEY,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(SC202CS_MIPI_RAW_24690)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_24690,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},//5
            {AVDD, Vol_2800, 1},//3
...
#endif
#if defined(GC02M1_MIPI_RAW_24690)
    {
        SENSOR_DRVNAME_GC02M1_MIPI_RAW_24690,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
//rado
#if defined(OV50D40_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_OV50D40_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 3},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(OV13B10_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_OV13B10_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(SC820CS_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_SC820CS_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 5},
            {DVDD, Vol_1200, 4},
...
#endif
#if defined(HI846_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_HI846_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 1},
            {AVDD, Vol_2800, 0},
            {DVDD, Vol_1200, 0},
...
#endif
#if defined(SC202CS_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_SC202CS_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 0},
            {DOVDD, Vol_1800, 0},//5
            {AVDD, Vol_2800, 1},//3
...
#endif
#if defined(S5KJNS_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_S5KJNS_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 1},
            {DOVDD, Vol_1800, 1},
            {AVDD1_GPIO, Vol_High, 2},
...
#endif
#if defined(GC02M3_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_GC02M3_MIPI_RAW_RADO,
        {
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
            {AVDD, Vol_2800, 1},
...
#endif
#if defined(IMX471_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_IMX471_MIPI_RAW_RADO,
        {
            {RST, Vol_Low, 1},
            {AVDD, Vol_2900, 0},
            {DVDD, Vol_1100, 0},
...
#endif
#if defined(GC32E2_MIPI_RAW_RADO)
    {
        SENSOR_DRVNAME_GC32E2_MIPI_RAW_RADO,
        {
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low,  1},
            {DOVDD, Vol_1800, 1},
